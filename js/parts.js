class PageModule {
	...
	constructor(path) {
		this.path = path;
		this.loadedOuterScriptsCounter = 0;
		this.outerScripts = [];
		this.innerScripts = [];
	}
...
var PartsLoader = {
	...
	onDOMLoaded: function() {
		this.build();
		for(let index = 0; index != this.onLoadListeners.length; index++) {
			this.onLoadListeners[index]();
		}
	}
};

document.addEventListener("DOMContentLoaded", () => { 
	PartsLoader.onDOMLoaded(); 
});
